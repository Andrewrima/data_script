...
$button.Add_Click({
    ...
    if($ComboBox1.Text -eq 'PostgreODBC x64'){
        try{$file = "\\SERVER01\PostgreODBC\PostgreODBC_v09.00.0101_x64.msi"
        ...
        catch{$Label1.text =  "Erro ao instalar o PostgreODBC x64" 
    ...
    if($ComboBox1.Text -eq 'Bibliotecas Python'){
        ...
        catch{$Label1.text =  "Erro ao instalar Bibliotecas Python" 
        $Label1.ForeColor = "Red"}
    ...
    if($ComboBox1.Text -eq 'PostgreODBC x32'){
        try{$file = "\\SERVER01\PostgreODBC\PostgreODBC_v08.04.0200_x32.msi"
            $descricao = $ComboBox2.Text
            $computerName = (Get-AdComputer -Filter * -Properties Name, Description | select Name, Description | ? {$_.Description -match $descricao}).Name
        ...
        catch{$Label1.text =  "Erro ao instalar o PostgreODBC x32" 
        $Label1.ForeColor = "Red"}
    ...
    if($ComboBox1.Text -eq 'Desinstalar Office 365'){
        try{$file = "\\SERVER01\Office2021Apps\Office2021Apps.exe"
            $file2 = "\\SERVER01\Office2021Apps\Remove.xml"
            $descricao = $ComboBox2.Text
            $computerName = (Get-AdComputer -Filter * -Properties Name, Description | select Name, Description | ? {$_.Description -match $descricao}).Name
        ...
        catch{$Label1.text =  "Erro ao desinstalar o Office 365" 
        $Label1.ForeColor = "Red"}
    ...
    if($ComboBox1.Text -eq 'Office 365 x32'){
        try{$file = "\\SERVER01\Office2021Apps\Office2021Apps.exe"
            $file2 = "\\SERVER01\Office2021Apps\Configuracao.xml"
            $descricao = $ComboBox2.Text
            $computerName = (Get-AdComputer -Filter * -Properties Name, Description | select Name, Description | ? {$_.Description -match $descricao}).Name
        ...
        catch{$Label1.text =  "Erro ao Instalar o Office 365." 
        $Label1.ForeColor = "Red"}
    ...
    try{$file = "\\SERVER01\Office2021Apps\Office2021Apps.exe"
        $file2 = "\\SERVER01\Office2021Apps\Configuracao_x64.xml"
        $descricao = $ComboBox2.Text
        $computerName = (Get-AdComputer -Filter * -Properties Name, Description | select Name, Description | ? {$_.Description -match $descricao}).Name
    ...
    catch{$Label1.text =  "Erro ao Instalar o Office 365 x64." 
    $Label1.ForeColor = "Red"}
    ...
    try{$file = "\\SERVER01\Office2016\x32"
        $descricao = $ComboBox2.Text
        $computerName = (Get-AdComputer -Filter * -Properties Name, Description | select Name, Description | ? {$_.Description -match $descricao}).Name
    ...
    catch{$Label1.text =  "Erro ao Instalar o Office 16 x32." 
    $Label1.ForeColor = "Red"}
    ...
    try{$file = "\\SERVER01\Office2016\x64"
        $descricao = $ComboBox2.Text
        $computerName = (Get-AdComputer -Filter * -Properties Name, Description | select Name, Description | ? {$_.Description -match $descricao}).Name
    ...
    catch{$Label1.text =  "Erro ao Instalar o Office 16 x64." 
    $Label1.ForeColor = "Red"}
    ...
    if($ComboBox1.Text -eq 'DBeaver'){
        try{$file = "\\FSKPTL01\TI\Disks\_Dbeaver\Dbeaver CE v6.0.5.exe"
            $descricao = $ComboBox2.Text
            $computerName = (Get-AdComputer -Filter * -Properties Name, Description | select Name, Description | ? {$_.Description -match $descricao}).Name
        ...
        catch{$Label1.text =  "Erro ao Instalar o DBeaver." 
        $Label1.ForeColor = "Red"}
    ...
    if($ComboBox1.Text -eq 'Foxit Reader'){
        try{$file = "\\FSKPTL01\TI\Disks\Foxit Reader\Foxit Reader v722.0929.exe"
            $descricao = $ComboBox2.Text
            $computerName = (Get-AdComputer -Filter * -Properties Name, Description | select Name, Description | ? {$_.Description -match $descricao}).Name
        ...
        catch{$Label1.text =  "Erro ao instalar o Foxit Reader" 
        $Label1.ForeColor = "Red"}
    ...
    if($ComboBox1.Text -eq 'Pycharm Community'){
        try{$file = "\\FSKPTL01\TI\Disks\PyCharm\Pycharm Community v2022.2.3.exe"
            $descricao = $ComboBox2.Text
            $computerName = (Get-AdComputer -Filter * -Properties Name, Description | select Name, Description | ? {$_.Description -match $descricao}).Name
        ...
        catch{$Label1.text =  "Erro ao instalar o Pycharm Community" 
        $Label1.ForeColor = "Red"}
    ...
    if($ComboBox1.Text -eq 'R 4.2.2'){
        try{$file = "\\FSKPTL01\TI\Disks\RStudio\R 4.2.2.exe"
            $descricao = $ComboBox2.Text
            $computerName = (Get-AdComputer -Filter * -Properties Name, Description | select Name, Description | ? {$_.Description -match $descricao}).Name
        ...
        catch{$Label1.text =  "Erro ao instalar o R 4.2.2" 
        $Label1.ForeColor = "Red"}
    ...
    if($ComboBox1.Text -eq 'RStudio'){
        try{$file = "\\FSKPTL01\TI\Disks\RStudio\RStudio 2022.07.2.exe"
            $descricao = $ComboBox2.Text
            $computerName = (Get-AdComputer -Filter * -Properties Name, Description | select Name, Description | ? {$_.Description -match $descricao}).Name
        ...
        catch{$Label1.text =  "Erro ao instalar o RStudio" 
        $Label1.ForeColor = "Red"}
    ...
    if($ComboBox1.Text -eq 'Refinitiv Messenger'){
        try{$file = "\\FSKPTL01\TI\Disks\Refinitiv Messenger\Refinitiv Messenger v1.11.385.exe"
            $descricao = $ComboBox2.Text
            $computerName = (Get-AdComputer -Filter * -Properties Name, Description | select Name, Description | ? {$_.Description -match $descricao}).Name
        ...
        catch{$Label1.text =  "Erro ao instalar o Refinitiv Messenger" 
        $Label1.ForeColor = "Red"}
    ...
    if($ComboBox1.Text -eq 'Visual Studio Code'){
        try{$file = "\\FSKPTL01\TI\Disks\Visual Studio Code\VSCodeSetup.exe"
            $descricao = $ComboBox2.Text
            $computerName = (Get-AdComputer -Filter * -Properties Name, Description | select Name, Description | ? {$_.Description -match $descricao}).Name
        ...
        catch{$Label1.text =  "Erro ao instalar o Visual Studio Code" 
        $Label1.ForeColor = "Red"}
    ...
    if($ComboBox1.Text -eq 'PowerBI'){
        ...
        catch{$Label1.text =  "Erro ao instalar o PowerBI" 
        $Label1.ForeColor = "Red"}
    ...
    if($ComboBox1.Text -eq 'Teamviewer'){
        try{$file = "\\FSKPTL01\TI\Disks\Teamviewer\Teamviewer.msi"
        ...
        catch{$Label1.text =  "Erro ao instalar o Teamviewer" 
        $Label1.ForeColor = "Red"}
