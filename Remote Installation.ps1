...
#   start-process Add-WindowsCapability -ArgumentList "‚Äìonline ‚ÄìName Rsat.ActiveDirectory*" -Wait                                    #
...
<#
 Pega todos os computadores do AD com base na nomenclatura da hashtable e Mostra a DescriÁ„o dos computadores
 #>
...
# √çcone base64 pego no site https://icons8.com/icons/set/base-64
