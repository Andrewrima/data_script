...
# URL da API do ThingSpeak
    url = "https://api.thingspeak.com/channels/2236257/feeds.json?api_key=4SKVC1SB1QPIU3NC&results=2"
    ...
    if response.status_code == 200:
        ...
        if len(feeds) >= 2:
            ...
            packet = [ ZabbixMetric('CPD Thermometer', 'temp11', temperatura), ZabbixMetric('CPD Thermometer', 'umid11', umidade)]
